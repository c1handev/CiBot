export default function Privacy() {
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        <p>⊳ Her discord sunucusu CiBot botunu ücretsiz olarak kullanabilir, ücret karşılığında satışı veya pazarlaması kesinlikle yasaktır. <a className="text-white">(READ MESSAGES, SEND MESSAGES, EMBED LINKS, ATTACH FILES, READ MESSAGE HISTORY, CONNECT, SPEAK, USE VOICE ACTIVITY, PRIORITY SPEAKER)</a></p>
