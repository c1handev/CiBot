export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">CiBot için Gizlilik Politikası</h1>
            <p className="text-sm text-white/30 mb-4">Son Güncelleme 4.08.2024 🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <div className="py-3"></div>
        <p>⊳ CiBot, kullanıcılara dayalı hiçbir veriyi kaydetmez.</p>
        <div className="py-3"></div>
